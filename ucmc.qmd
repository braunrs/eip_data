...
patients <- rbind(patients1, patients2, patients3, patients4, patients5, patients6, patients7, patients8, patients9, patients10,
                  ...
                  patients41, patients42, patients43, patients44, patients45, patients46, patients47, patients48, patients49)
dim(patients)
head(patients)
...
ucmc_monthly_tbl[nrow(ucmc_monthly_tbl) + 1,] <- list('Totals (*YTD*)', ucmc_encounters, ucmc_patients)
ucmc_monthly_tbl %>%
  kbl() %>%
