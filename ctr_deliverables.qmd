...
summary(eip$enc_date)
ctr <- eip[which(eip$enc_date >= '2023-01-01' & eip$enc_date <= '2024-06-30'), ]
...
ctr_msm_assessed_deliverable <- 140
...
ctr_msm_wch_test_deliverable <- 10
...
ctr_hrhs_tested_deliverable <- 900
...
ctr_hrhs_wch_tested_deliverable <- 100
...
ctr_plwha_ucmc_deliverable <- 100
...
monthly_ctr_tests_plot <- plot_ly(data = monthly_ctr_tests, x = ~Date, y = ~ctr_tests, type = 'bar', name = 'CTR Tests',
...
# CTR Deliverable Update Table
ctr_deliverables_update_tbl <- data.frame(matrix(ncol = 4, nrow = 0))
colnames(ctr_deliverables_update_tbl) <- c('CTR Deliverable', 'Prior Goal', 'Updated Goal', 'Change')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('PLWHA not in care', 100, 125, '+25')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('PLWHA at UCMC', 75, 100, '+25')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('PLWHA/WOC', 20, 25, '+5')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('PLWHA/IDU', 25, 35, '+10')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('MSM assessed', 100, 140, '+40')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('MSM/Youth tested', 20, 25, '+5')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('MSM/IDU tested', 20, 25, '+5')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('HRHS assessed', 1000, 1150, '+150')
ctr_deliverables_update_tbl[nrow(ctr_deliverables_update_tbl) + 1,] <- list('HRHS/WOC tested', 100, 130, '+30')
ctr_deliverables_update_tbl %>%
  kbl(align = 'lccc', table.attr = 'data-quarto-disable-processing="true"') %>%
  kable_paper(bootstrap_options = "striped", full_width = F) %>%
  pack_rows("PLWHA", 1, 4, label_row_css = "background-color: #F0F0F0") %>%
  pack_rows("MSM", 5, 7, label_row_css = "background-color: #F0F0F0") %>%
  pack_rows("HRHS", 8, 9, label_row_css = "background-color: #F0F0F0") %>%
...
ctr_plwha_site_bullet <- plot_ly() %>%
  add_trace(type = "indicator",
            ...
            title =list(text = "<b><span style='font-size:0.75em'>UCMC</b></span><br><span style='color: gray; font-size:0.6em'>PLWHA Deliverable: 75</span>"),
  ...
  add_trace(type = "indicator",
            ...
            title = list(text = "<b><span style='font-size:0.75em'>WCH</b></span><br><span style='color: gray; font-size:0.6em'>PLWHA Deliverable: 15</span>"),
            gauge = list(shape = "bullet",
                         axis = list(range = list(0, 100)),
                         threshold = list(line = list(color = "red", width = 2),
                                          thickness = 0.75,
...
ctr_msm_tested_site_bullet <- plot_ly() %>%
  ...
  add_trace(type = "indicator",
            ...
            domain = list(x = c(0.20, 0.65), y = c(0.45, 0.55)),
            title = list(text = "<b><span style='font-size:0.75em'>WCH</b></span><br><span style='color: gray; font-size:0.6em'>MSM Tested Deliverable: 10</span>"),
            gauge = list(shape = "bullet",
...
monthly_msm_tests_plot <- plot_ly(data = monthly_msm_tests, x = ~Date, y = ~ctr_tests, type = 'bar', name = 'MSM CTR Tested',
                                  text = ~ctr_tests, textposition = 'auto',
                                  marker = list(color = 'lightskyblue')) %>%
  layout(yaxis = list(title = 'MSM CTR Tested'), barmode = 'stack',
         xaxis = list(tickangle = 45))
monthly_msm_tests_plot
...
ctr_hrhs_tested_site_bullet <- plot_ly() %>%
  ...
  add_trace(type = "indicator",
            ...
            domain = list(x = c(0.20, 0.65), y = c(0.45, 0.55)),
            title = list(text = "<b><span style='font-size:0.75em'>WCH</b></span><br><span style='color: gray; font-size:0.6em'>HRHS Test Deliverable: 100</span>"),
            gauge = list(shape = "bullet",
...
monthly_hrhs_tests_plot <- plot_ly(data = monthly_hrhs_tests, x = ~Date, y = ~ctr_tests, type = 'bar', name = 'HRHS CTR Tested',
                                  text = ~ctr_tests, textposition = 'auto',
                                  marker = list(color = 'lightskyblue')) %>%
  layout(yaxis = list(title = 'HRHS CTR Tested'), barmode = 'stack',
         xaxis = list(tickangle = 45))
monthly_hrhs_tests_plot
