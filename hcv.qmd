...
# EIP Database Data
eip <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20241028_0940.csv')
dim(eip)

# HCV Epic Dashboard Data
hcv_jan <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 01_2024.csv')
dim(hcv_jan)
hcv_feb <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 02_2024.csv')
dim(hcv_feb)
hcv_mar <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 03_2024.csv')
dim(hcv_mar)
hcv_apr <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 04_2024.csv')
dim(hcv_apr)
hcv_may <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 05_2024.csv')
dim(hcv_may)
hcv_jun <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 06_2024.csv')
dim(hcv_jun)
hcv_jul <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 07_2024.csv')
dim(hcv_jul)
hcv_aug <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 08_2024.csv')
dim(hcv_aug)
hcv_sep <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 09_2024.csv')
dim(hcv_sep)
hcv_oct <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/Monthly Data/HCV Dashboard Data 10_2024.csv')
dim(hcv_oct)

hcv <- rbind(hcv_jan, hcv_feb, hcv_mar, hcv_apr, hcv_may, hcv_jun,
             hcv_jul, hcv_aug, hcv_sep, hcv_oct)
dim(hcv)
hcv <- distinct(hcv)
dim(hcv)
head(hcv)
