...
# EIP Database Data
eip <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20240429_0804.csv')
dim(eip)
...
hcv <- rbind(hcv1, hcv2, hcv3, hcv4, hcv5, hcv6, hcv7, hcv8, hcv9, hcv10, hcv11, hcv12, hcv13)
dim(hcv)
hcv <- distinct(hcv)
dim(hcv)
head(hcv)
