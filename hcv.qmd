...
# EIP Database Data
eip <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20240923_0807.csv')
dim(eip)
...
hcv <- rbind(hcv_jan, hcv_feb, hcv_mar, hcv_apr, hcv_may, hcv_jun, hcv_jul, hcv_aug, hcv_sep)
dim(hcv)
hcv <- distinct(hcv)
dim(hcv)
head(hcv)
