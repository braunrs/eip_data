...
# EIP Database Data
eip <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20240624_1012.csv')
dim(eip)
...
dim(hcv_may)
hcv_jun1 <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/HCV Dashboard Data 20240601 to 20240615.csv')
dim(hcv_jun1)
hcv_jun2 <- read.csv('M:/EIP Data/External Data Sources/Epic Data/HCV Dashboard/HCV Dashboard Data 20240616 to 20240630.csv')
dim(hcv_jun2)

hcv <- rbind(hcv_jan, hcv_feb, hcv_mar, hcv_apr, hcv_may, hcv_jun1, hcv_jun2)
dim(hcv)
hcv <- distinct(hcv)
dim(hcv)
head(hcv)
