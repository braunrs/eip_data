...
nalox <- read.csv('M:/EIP Data/EIP Database/EIP Naloxone Distribution Database/EIP Naloxone Distribution/EIP Naloxone Distribution Data 20250208_1438.csv')
dim(nalox)
...
enc$hcph_sud_90day_eligible <- ifelse((enc$ltc_sud_hcph_30day_completion == 1 &
...
hcph_sud_90day_eligible_percent <- percent(hcph_sud_90day_eligible/hcph_sud_30day_complete, accuracy = 0.1)
hcph_sud_90day_eligible_percent


enc$hcph_sud_90day_complete[enc$ltc_sud_hcph_30day_completion == 1 &
