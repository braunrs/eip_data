...
nalox <- read.csv('M:/EIP Data/EIP Database/EIP Naloxone Distribution Database/EIP Naloxone Distribution/EIP Naloxone Distribution Data 20241112_1159.csv')
dim(nalox)
...
enc$hcph_sud_linkage_need[enc$ltc_services___3 == 1 & enc$hcph_opioid_stimulant_use == 1] <- 1
...
enc$hcph_sud_fu_consent[enc$hcph_sud_linked == 1 &
                          (enc$ltc_sud_hcph_fu == 1 | is.na(enc$ltc_sud_hcph_fu) | enc$ltc_sud_hcph_fu == '')] <- 1
...
enc$hcph_sud_30day_eligible <- ifelse(((enc$hcph_sud_fu_consent == 1 |
                                         is.na(enc$hcph_sud_fu_consent) | enc$hcph_sud_fu_consent == '') &
...
enc$hcph_sud_30day_complete[enc$ltc_sud_hcph_30day_completion == 1] <- 1 
...
enc$hcph_sud_180day_eligible <- ifelse((enc$ltc_sud_hcph_60day_completion == 1 &
...
hcph_sud_180day_eligible_percent <- percent(hcph_sud_180day_eligible/hcph_sud_60day_complete, accuracy = 0.1)
hcph_sud_180day_eligible_percent



enc$hcph_sud_180day_complete[enc$ltc_sud_hcph_60day_completion == 1 &
...
grid +
  ...
  geom_rect(xmin = 0, xmax = 22, ymin = 90, ymax = 100, color = 'black',
            fill = 'white', size = 0.25, size = 0.25) +
  annotate('text', x = 10.5, y = 97, label = 'Agreed to Follow-up', size = 2) +
  geom_rect(xmin = 0, xmax = 22, ymin = 90, ymax = 100, color = NA,
            fill = NA, size = 0.25) +
  annotate('text', x = 10.5, y = 93, label = hcph_sud_fu_consent, size = 2, color = 'forestgreen') +
  
  
  # HCPH 30-day Eligible
  geom_rect(xmin = 0, xmax = 22, ymin = 60, ymax = 70, color = 'black',
            fill = 'white', size = 0.25, size = 0.25) +
  annotate('text', x = 10.5, y = 67, label = 'Eligible for 30-day follow-up', size = 2) +
  geom_rect(xmin = 0, xmax = 22, ymin = 60, ymax = 70, color = NA,
            fill = NA, size = 0.25) +
  annotate('text', x = 10.5, y = 63, label = hcph_sud_30day_eligible, size = 2, color = 'forestgreen') +
  annotate('text', x = 19, y = 63, label = hcph_sud_30day_eligible_percent, size = 2, color = 'darkseagreen4') +
  
  
  # HCPH 30-day Complete
  geom_rect(xmin = 32, xmax = 54, ymin = 60, ymax = 70, color = 'black',
            fill = 'white', size = 0.25, size = 0.25) +
  annotate('text', x = 42.5, y = 67, label = '30-day follow-up complete', size = 2) +
  geom_rect(xmin = 32, xmax = 54, ymin = 60, ymax = 70, color = NA,
            fill = NA, size = 0.25) +
  annotate('text', x = 42.5, y = 63, label = hcph_sud_30day_complete, size = 2, color = 'forestgreen') +
  annotate('text', x = 50.5, y = 63, label = hcph_sud_30day_complete_percent, size = 2, color = 'darkseagreen4') +
  
  
  # HCPH 60-day Eligible
  geom_rect(xmin = 32, xmax = 54, ymin = 30, ymax = 40, color = 'black',
            fill = 'white', size = 0.25, size = 0.25) +
  annotate('text', x = 42.5, y = 37, label = 'Eligible for 60-day follow-up', size = 2) +
  geom_rect(xmin = 32, xmax = 54, ymin = 30, ymax = 40, color = NA,
            fill = NA, size = 0.25) +
  annotate('text', x = 42.5, y = 33, label = hcph_sud_60day_eligible, size = 2, color = 'forestgreen') +
  annotate('text', x = 50.5, y = 33, label = hcph_sud_60day_eligible_percent, size = 2, color = 'darkseagreen4') +
  
  
  # HCPH 60-day Complete
  geom_rect(xmin = 64, xmax = 86, ymin = 30, ymax = 40, color = 'black',
            fill = 'white', size = 0.25, size = 0.25) +
  annotate('text', x = 74.5, y = 37, label = '60-day follow-up complete', size = 2) +
  geom_rect(xmin = 64, xmax = 86, ymin = 30, ymax = 40, color = NA,
            fill = NA, size = 0.25) +
  annotate('text', x = 74.5, y = 33, label = hcph_sud_60day_complete, size = 2, color = 'forestgreen') +
  annotate('text', x = 84.5, y = 33, label = hcph_sud_60day_complete_percent, size = 2, color = 'darkseagreen4') +
  
  
  # HCPH 180-day Eligible
  geom_rect(xmin = 64, xmax = 86, ymin = 0, ymax = 10, color = 'black',
            fill = 'white', size = 0.25, size = 0.25) +
  annotate('text', x = 74.5, y = 7, label = 'Eligible for 180-day follow-up', size = 2) +
  geom_rect(xmin = 64, xmax = 86, ymin = 0, ymax = 10, color = NA,
            fill = NA, size = 0.25) +
  annotate('text', x = 74.5, y = 3, label = hcph_sud_180day_eligible, size = 2, color = 'forestgreen') +
  annotate('text', x = 84.5, y = 3, label = hcph_sud_180day_eligible_percent, size = 2, color = 'darkseagreen4') +
  
  
  # HCPH 180-day Complete
  geom_rect(xmin = 96, xmax = 118, ymin = 0, ymax = 10, color = 'black',
            fill = 'white', size = 0.25, size = 0.25) +
  annotate('text', x = 106.5, y = 7, label = '180-day follow-up complete', size = 2) +
  geom_rect(xmin = 96, xmax = 118, ymin = 0, ymax = 10, color = NA,
            fill = NA, size = 0.25) +
  annotate('text', x = 106.5, y = 3, label = hcph_sud_180day_complete, size = 2, color = 'forestgreen') +
  annotate('text', x = 116.5, y = 3, label = hcph_sud_180day_complete_percent, size = 2, color = 'darkseagreen4') +
  ...
  geom_segment(
    x = 10.5, xend = 10.5, y = 90, yend = 70, 
    size = 0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(2,"mm"), type = "closed"), color = 'black') +
  
  # Down Arrow 2
  geom_segment(
    x = 42.5, xend = 42.5, y = 60, yend = 40, 
    size = 0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(2,"mm"), type = "closed"), color = 'black') +
  
  # Down Arrow 3
  geom_segment(
    x = 74.5, xend = 74.5, y = 30, yend = 10, 
    size = 0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(2,"mm"), type = "closed"), color = 'black') +
  
  # Right Arrow 1
  geom_segment(
    x = 22, xend = 32, y = 65, yend = 65, 
    size = 0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(2,"mm"), type = "closed"), color = 'black') +
  
  # Right Arrow 2
  geom_segment(
    x = 54, xend = 64, y = 35, yend = 35, 
    size = 0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(2,"mm"), type = "closed"), color = 'black') +
  
  # Right Arrow 3
  geom_segment(
    x = 86, xend = 96, y = 5, yend = 5, 
    size = 0.15, linejoin = "mitre", lineend = "butt",
    arrow = arrow(length = unit(2,"mm"), type = "closed"), color = 'black')->
  grid
