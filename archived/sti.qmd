...
# CHI Lab Files
labs1 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240102.csv')
dim(labs1)
labs2 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240109.csv')
dim(labs2)
labs3 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240116.csv')
dim(labs3)
labs4 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240123.csv')
dim(labs4)
labs5 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240130.csv')
dim(labs5)
labs6 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240202.csv')
dim(labs6)
labs7 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240206.csv')
dim(labs7)
labs8 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240213.csv')
dim(labs8)
labs9 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240220.csv')
dim(labs9)
labs10 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240227.csv')
dim(labs10)
labs11 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240304.csv')
dim(labs11)
labs12 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240305.csv')
dim(labs12)
labs13 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240312.csv')
dim(labs13)
labs14 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240319.csv')
dim(labs14)
labs15 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240326.csv')
dim(labs15)
labs16 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240416.csv')
dim(labs16)
labs17 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240423.csv')
dim(labs17)
labs18 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240430.csv')
dim(labs18)
labs19 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240502.csv')
dim(labs19)
labs20 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240507.csv')
dim(labs20)
labs21 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240514.csv')
dim(labs21)
labs22 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240521.csv')
dim(labs22)
labs23 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240530.csv')
dim(labs23)
labs24 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240611.csv')
dim(labs24)
labs25 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240618.csv')
dim(labs25)
labs26 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240625.csv')
dim(labs26)
labs27 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240701.csv')
dim(labs27)
labs28 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240705.csv')
dim(labs28)
labs29 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240709.csv')
dim(labs29)
labs30 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240716.csv')
dim(labs30)
labs31 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240723.csv')
dim(labs31)
labs32 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240730.csv')
dim(labs32)
labs33 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240802.csv')
dim(labs33)
labs34 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240806.csv')
dim(labs34)
labs35 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240806.csv')
dim(labs35)
labs36 <- read.csv('M:/EIP Data/External Data Sources/CHI Data/2024/DPI_1009_labs_hiv_hcv_hepc_complete_20240806.csv')
dim(labs36)

labs <- rbind(labs1,labs2,labs3,labs4,labs5,labs6,labs7,labs8,labs9,labs10,
              labs11,labs12,labs13,labs14,labs15,labs16,labs17,labs18,labs19,labs20,
              labs21,labs22,labs23,labs24,labs25,labs26,labs27,labs28,labs29,labs30,
              labs31,labs32,labs33,labs34,labs35,labs36)
dim(labs)
head(labs)
...
```{r CCTST Syphilis Testing, include=FALSE}

# Formatting labs for what is needed

labs <- labs[which(labs$ORDER_STATUS == 'Completed'), ]
labs <- labs[which(labs$DEPARTMENT_NAME == 'UH EMERGENCY DEPT'), ]
labs <- labs[which(labs$PROC_NAME == 'TREPONEMA PALLIDUM AB WITH REFLEX' | labs$PROC_NAME == 'RPR W TITER'), ]
summary(labs$ORDERING_DATE)
labs$ORDERING_DATE <- as.Date(labs$ORDERING_DATE, format = '%m/%d/%Y')
summary(labs$ORDERING_DATE)
labs <- labs[which(labs$ORDERING_DATE >= '2024-01-01'), ]
summary(labs$ORDERING_DATE)


syph <- select(labs, -EPIC_PAT_ID, -LAST_NAME, -FIRST_NAME, -MIDDLE_NAME, -DOB,
               -PROC_NAME, -PROC_ID, -PROC_CODE, -ORDER_PROC_ID, -ORDER_STATUS_CODE, -ORDER_STATUS, -RESULT_TIME,
               -ORDER_DESCRIPTION, -RESULT_LINE_NUMBER, -COMPONENT_ID, -COMPONENT_ABBREV,
               -LAB_STATUS, -AUTHRZING_PROV, -AUTHRZING_PROV_TYPE, -AUTHRZING_PROV_CLINICIAN_TITLE,
               -BILLING_PROV, -BILLING_PROV_TYPE, -BILLING_PROV_CLINICIAN_TITLE,- ORD_CREATR_USER,
               -TECHNOLOGIST_ID, -INSTNTOR_USER_ID, -FUTURE_OR_STAND, -INSTANTIATED_TIME,
               -ADT_DEPARTMENT_ID, -ADT_DEPARTMENT_NAME, -PAT_LOC_ID, -DEPARTMENT_NAME)
head(syph)
dim(syph)
...
colnames(syph)[1] <- 'mrn'
colnames(syph)[2] <- 'csn'
colnames(syph)[3] <- 'order_date'
head(syph)




# Creating main dataset to match variables to (by csn)

syph_main <- select(syph, csn)
dim(syph_main)
syph_main <- distinct(syph_main)
dim(syph_main)
head(syph_main)
...
syph_tested <- syph[which(syph$RESULT_VALUE == 'Positive' | syph$RESULT_VALUE == 'Negative'), ]
dim(syph_tested)
head(syph_tested)
syph_tested <- select(syph_tested, csn, order_date)
dim(syph_tested)
syph_tested <- distinct(syph_tested)
dim(syph_tested)
syph_tested$syph_tested <- 1
head(syph_tested)
dim(syph_tested)
dim(syph_main)
syph_main <- merge(syph_main, syph_tested, by = 'csn', all.x = T)
dim(syph_main)
head(syph_main)
syph_main$syph_tested[is.na(syph_main$syph_tested)] <- ''
table(syph_main$syph_tested)
head(syph_main)
syph_main$dup <- duplicated(syph_main$csn)
syph_main <- syph_main[which(syph_main$dup == F), ]
dim(syph_main)
syph_main <- select(syph_main, -dup)
head(syph_main)


syph_trepia <- syph[which(syph$COMPONENT_NAME == 'TREPIA'), ]
dim(syph_trepia)
head(syph_trepia)
table(syph_trepia$RESULT_VALUE)

syph_trepia_pos <- syph_trepia[which(syph_trepia$RESULT_VALUE == 'Positive'), ]
dim(syph_trepia_pos)
head(syph_trepia_pos)
syph_trepia_pos <- select(syph_trepia_pos, csn)
dim(syph_trepia_pos)
syph_trepia_pos <- distinct(syph_trepia_pos)
dim(syph_trepia_pos)
syph_trepia_pos$syph_trepia_pos <- 1
head(syph_trepia_pos)
dim(syph_trepia_pos)
dim(syph_main)
syph_main <- merge(syph_main, syph_trepia_pos, by = 'csn', all.x = T)
dim(syph_main)
head(syph_main)
syph_main$syph_trepia_pos[is.na(syph_main$syph_trepia_pos)] <- ''
table(syph_main$syph_trepia_pos)
head(syph_main)

syph_trepia_neg <- syph_trepia[which(syph_trepia$RESULT_VALUE == 'Negative'), ]
dim(syph_trepia_neg)
head(syph_trepia_neg)
syph_trepia_neg <- select(syph_trepia_neg, csn)
dim(syph_trepia_neg)
syph_trepia_neg <- distinct(syph_trepia_neg)
dim(syph_trepia_neg)
syph_trepia_neg$syph_trepia_neg <- 1
head(syph_trepia_neg)
dim(syph_trepia_neg)
dim(syph_main)
syph_main <- merge(syph_main, syph_trepia_neg, by = 'csn', all.x = T)
dim(syph_main)
head(syph_main)
syph_main$syph_trepia_neg[is.na(syph_main$syph_trepia_neg)] <- ''
table(syph_main$syph_trepia_neg)
head(syph_main)


syph_rpr <- syph[which(syph$COMPONENT_NAME == 'RPR WITH REFLEX'), ]
dim(syph_rpr)
head(syph_rpr)
table(syph_rpr$RESULT_VALUE)

syph_rpr_pos <- syph_rpr[which(syph_rpr$RESULT_VALUE == 'Reactive'), ]
dim(syph_rpr_pos)
head(syph_rpr_pos)
syph_rpr_pos <- select(syph_rpr_pos, csn)
dim(syph_rpr_pos)
syph_rpr_pos <- distinct(syph_rpr_pos)
dim(syph_rpr_pos)
syph_rpr_pos$syph_rpr_pos <- 1
head(syph_rpr_pos)
dim(syph_rpr_pos)
dim(syph_main)
syph_main <- merge(syph_main, syph_rpr_pos, by = 'csn', all.x = T)
dim(syph_main)
head(syph_main)
syph_main$syph_rpr_pos[is.na(syph_main$syph_rpr_pos)] <- ''
table(syph_main$syph_rpr_pos)
head(syph_main)

syph_rpr_neg <- syph_rpr[which(syph_rpr$RESULT_VALUE == 'Non-Reactive'), ]
dim(syph_rpr_neg)
head(syph_rpr_neg)
syph_rpr_neg <- select(syph_rpr_neg, csn)
dim(syph_rpr_neg)
syph_rpr_neg <- distinct(syph_rpr_neg)
dim(syph_rpr_neg)
syph_rpr_neg$syph_rpr_neg <- 1
head(syph_rpr_neg)
dim(syph_rpr_neg)
dim(syph_main)
syph_main <- merge(syph_main, syph_rpr_neg, by = 'csn', all.x = T)
dim(syph_main)
head(syph_main)
syph_main$syph_rpr_neg[is.na(syph_main$syph_rpr_neg)] <- ''
table(syph_main$syph_rpr_neg)
head(syph_main)


# Creating variables for total number of daily tests

syph_tested <- syph_main[which(syph_main$syph_tested == 1), ]
syph_tested <- nrow(syph_tested)
syph_tested


syph_main$syph_reactive[syph_main$syph_trepia_pos == 1] <- 1
syph_main$syph_reactive[is.na(syph_main$syph_reactive)] <- 0
table(syph_main$syph_reactive)
syph_reactive <- syph_main[which(syph_main$syph_reactive == 1), ]
syph_reactive <- nrow(syph_reactive)
syph_reactive


syph_main$syph_positive[syph_main$syph_reactive == 1 & syph_main$syph_rpr_pos == 1] <- 1
syph_main$syph_positive[is.na(syph_main$syph_positive)] <- 0
table(syph_main$syph_positive)
syph_positive <- syph_main[which(syph_main$syph_positive == 1), ]
syph_positive <- nrow(syph_positive)
syph_positive


syph_main$syph_negative[syph_main$syph_reactive == 1 & syph_main$syph_rpr_neg == 1] <- 1
syph_main$syph_negative[is.na(syph_main$syph_negative)] <- 0
table(syph_main$syph_negative)
syph_negative <- syph_main[which(syph_main$syph_negative == 1), ]
syph_negative <- nrow(syph_negative)
syph_negative


syph_main$syph_indeterminate[syph_main$syph_reactive == 1 &
                               (syph_main$syph_rpr_pos == '' & syph_main$syph_rpr_neg == '')] <- 1
syph_main$syph_indeterminate[is.na(syph_main$syph_indeterminate)] <- 0
table(syph_main$syph_indeterminate)
syph_indeterminate <- syph_main[which(syph_main$syph_indeterminate == 1), ]
syph_indeterminate <- nrow(syph_indeterminate)
syph_indeterminate


# Sorting Syphilis dataset and removing untested

syph_main$order_date <- as.Date(syph_main$order_date, format = '%m/%d/%Y')
syph_main <- syph_main %>%
  mutate(month_year = floor_date(order_date, "month"))
head(syph_main)
syph_main <- syph_main[which(syph_main$syph_tested == 1), ]
dim(syph_main)

syph_main$syph_tested <- as.numeric(syph_main$syph_tested)

# Aggregate data by order_date
daily_syph_tests <- syph_main %>%
  group_by(order_date) %>%
  summarise(total_tests = sum(syph_tested),
            total_positive = sum(syph_positive),
            percent_positive = round((total_positive / total_tests) * 100, 1))
daily_syph_tests


monthly_syph_tests <- syph_main %>%
  group_by(month_year) %>%
  summarise(total_tests = sum(syph_tested),
            total_positive = sum(syph_positive),
            percent_positive = round((total_positive / total_tests) * 100, 1))
...
# Table of daily Syphilis testing
reactable(daily_syph_tests,
          columns = list(
            order_date = colDef(name = "Order Date", align = "center", width = 125),
            total_tests = colDef(name = "Syphilis Tests", align = "center", width = 130),
            total_positive = colDef(name = "Syphilis +", align = "center", width = 125),
...
#| label: CCTST Syphilis Screening - Daily
#| fig-cap: "*The red line indicates when EIP intervention began, prompting medical staff to include syphilis testing when appropriate.*"

# Line graph of daily Syphilis testing
eip_start_date_daily <- "2024-04-01"
daily_syph_tests_plot <- daily_syph_tests %>%
  plot_ly(x = ~order_date, y = ~total_tests, name = "Syphilis Tests", type = 'scatter', mode = 'lines', line = list(color = '#DC9540')) %>%
  add_trace(y = ~total_positive, name = "Syphilis+", line = list(color = 'royalblue')) %>%
  layout(
    xaxis = list(title = "Order Date"),
    yaxis = list(title = "Total Syphilis Tests", range = c(0, max(daily_syph_tests$total_tests) + 10)),
    title = list(text = "CHI Data Daily Syphilis Tests", font = list(size = 20)),
    margin = list(l = 50, r = 50, b = 50, t = 50),
    template = "plotly_dark",
    shapes = list(
      list(
        type = "line",
        x0 = eip_start_date_daily,
        x1 = eip_start_date_daily,
        y0 = 0,
        y1 = 1,
        yref = "paper",
        line = list(color = "red", dash = "dash")))) %>%
  config(displayModeBar = FALSE)
daily_syph_tests_plot
...
<div align="center">
``` {r, echo = FALSE, fig.frame="black"}
#| label: CCTST Syphilis Screening - Monthly
#| fig-cap: "*The red line indicates when EIP intervention began, prompting medical staff to include syphilis testing when appropriate.*"

# Line graph of monthly Syphilis testing
monthly_syph_tests <- monthly_syph_tests %>%
  mutate(month_year = format(month_year, "%Y-%m"))
eip_start_date_monthly <- "2024-04"
monthly_syph_tests_plot <- monthly_syph_tests %>%
  plot_ly(x = ~month_year, y = ~total_tests, name = "Syphilis Tests", type = 'scatter', mode = 'lines', line = list(color = '#DC9540')) %>%
  add_trace(y = ~total_positive, name = "Syphilis+", line = list(color = 'royalblue')) %>%
  layout(
    xaxis = list(title = "Order Date"),
    yaxis = list(title = "Total Syphilis Tests", range = c(0, max(monthly_syph_tests$total_tests) + 10)),
    title = list(text = "CHI Data Monthly Syphilis Tests", font = list(size = 20)),
    margin = list(l = 50, r = 50, b = 50, t = 50),
    template = "plotly_dark",
    shapes = list(
      list(
        type = "line",
        x0 = eip_start_date_monthly,
        x1 = eip_start_date_monthly,
        y0 = 0,
        y1 = 1,
        yref = "paper",
        line = list(color = "red", dash = "dash")))) %>%
  config(displayModeBar = FALSE)
monthly_syph_tests_plot
