...
The total number of unique individuals that EIP has encountered is **`XX`r unique_patients`**. The demographic information for this EIP population is shown on this page. For further information regarding the population demographics of individuals at particular sites, please refer to those pages listed under the **Site** tab in the navigation bar.
