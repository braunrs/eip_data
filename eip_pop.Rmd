...
The total number of unique individuals that EIP has encountered is **`r unique_patients`**. The demographic information for this EIP population is shown on this page. For further information regarding the population demographics of individuals at particular sites, please refer to those pages listed under the **Site** tab in the navigation bar.

## Age Distribution

This first histogram shows the ages of individuals seen by EIP grouped by age categories. The age categories in this histogram were chosen because they are the categories used in both the CTR and EHE reports to ODH.
...
This histogram shows the same data as the one above, however allows for the ability to display the age based on the self-reported gender of the individual. You can filter the information by selecting/deselecting the gender from the legend on the right side of the graph. If multiple gender categories are selected, the histogram shows the cumulative total for each age among the gender categories selected.
...
This histogram allows for the ability to display the age based on the self-reported race of the individual, excluding those who identified as 'Other' race or had an unknown race. You can filter the information as above.
...
Placeholder for data on sex at birth and gender identity.
