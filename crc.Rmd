...
colnames(table2) <- c('HIV+', 'HIV+ not in care', 'Homeless', 'Opiate Use', 'OD', 'Pregnant', 'PWID', 'Risk w/o test', 'Sexual Assault', 'STI+ past yr', 'Syph+ past yr')
table2[nrow(table2) + 1,] <- list(total_hiv_percent, total_idc_percent, total_homeless_percent, total_opiates_percent, total_overdose_percent, total_preg_percent, total_pwid_percent, total_risk_group_not_tested_percent, total_sex_assault_percent, total_sti_percent, total_sti_syph_percent)
reactable(table2)
