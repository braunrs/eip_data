...
summary(eip$enc_date)
ehe <- eip[which(eip$enc_date >= '2023-08-01' & eip$enc_date <= '2024-06-30'), ]
...
ehe_new_positive_deliverable_percent <- percent(ehe_new_positive/10, accuracy = 0.1)
...
ehe_msm_wch_test_deliverable <- 10
...
ehe_msm_comm_test_deliverable <- 10
...
ehe_hrhs_comm_assessed_deliverable <- 50
...
monthly_ehe_tests_plot <- plot_ly(data = monthly_ehe_tests, x = ~Date, y = ~ehe_tests, type = 'bar', name = 'EHE Tests',
...
ehe_msm_tested_site_bullet <- plot_ly() %>%
  add_trace(type = "indicator",
            ...
            title =list(text = "<b>UCMC</b><br><span style='color: gray; font-size:0.6em'>MSM Tested Deliverable: 40</span>"),
  ...
  add_trace(type = "indicator",
            ...
            title = list(text = "<b>WCH</b><br><span style='color: gray; font-size:0.6em'>MSM Tested Deliverable: 10</span>"),
            gauge = list(shape = "bullet",
  ...
  add_trace(type =  "indicator",
            ...
            title = list(text = "<b>Community</b><br><span style='color: gray; font-size:0.6em'>MSM Tested Deliverable: 10</span>"),
            gauge = list(shape = "bullet",
                         axis = list(range = list(0, 40)),
                         threshold = list(line = list(color = "red", width = 2),
                                          thickness = 0.75,
...
ehe_hrhs_site_bullet <- plot_ly() %>%
  add_trace(type = "indicator",
            ...
            title =list(text = "<b>UCMC</b><br><span style='color: gray; font-size:0.5em'>HRHS Assessed Deliverable: 350</span>"),
            gauge = list(shape = "bullet",
  ...
  add_trace(type =  "indicator",
            ...
            title = list(text = "<b>Community</b><br><span style='color: gray; font-size:0.5em'>HRHS Assessed Deliverable: 50</span>"),
            gauge = list(shape = "bullet",
                         axis = list(range = list(0, 350)),
                         threshold = list(line = list(color = "red", width = 2),
                                          thickness = 0.75,
