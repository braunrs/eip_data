...
eip$hiv_false_pos[(eip$hiv_result1 == 1 | eip$hiv_result1 == 2 |
                    eip$hiv_result2 == 1 | eip$hiv_result2 == 2 |
                    eip$hiv_result3 == 1 | eip$hiv_result3 == 2 |
                    eip$hiv_result4 == 1 | eip$hiv_result4 == 2 |
                    eip$hiv_result5 == 1 | eip$hiv_result5 == 2 |
                    eip$hiv_result6 == 1 | eip$hiv_result6 == 2) &
                    eip$final_test_status_hiv != 0] <- 1
table(eip$hiv_false_pos)
hiv_false_positives <- eip[which(eip$hiv_false_pos == 1), ]
...
monthly_hiv_false_pos <- select(eip, enc_date, record_id, hiv_false_pos)
monthly_hiv_false_pos <- monthly_hiv_false_pos[which(monthly_hiv_false_pos$hiv_false_pos == 1), ]
head(monthly_hiv_false_pos)
monthly_hiv_false_pos <- select(monthly_hiv_false_pos, -record_id)
head(monthly_hiv_false_pos)
monthly_hiv_false_pos$hiv_false_pos[is.na(monthly_hiv_false_pos$hiv_false_pos)] <- 0
head(monthly_hiv_false_pos)
...
monthly_hiv_false_pos <- aggregate(hiv_false_pos ~ Date,
...
annual_hiv_false_pos <- select(eip, enc_date, record_id, hiv_false_pos)
annual_hiv_false_pos <- annual_hiv_false_pos[which(annual_hiv_false_pos$hiv_false_pos == 1), ]
head(annual_hiv_false_pos)
annual_hiv_false_pos <- select(annual_hiv_false_pos, -record_id)
head(annual_hiv_false_pos)
annual_hiv_false_pos$hiv_false_pos[is.na(annual_hiv_false_pos$hiv_false_pos)] <- 0
head(annual_hiv_false_pos)
...
annual_hiv_false_pos <- aggregate(hiv_false_pos ~ Date,
...
months_elapsed <- 3
current_annual_hiv_false_pos_2026 <- annual_hiv_false_pos$hiv_false_pos[annual_hiv_false_pos$Date == 2026]
projected_annual_hiv_false_pos_2026 <- (current_annual_hiv_false_pos_2026 / months_elapsed) * 12
projection_df <- data.frame(
  Date = c(2025, 2026),
  hiv_false_pos = c(
    annual_hiv_false_pos$hiv_false_pos[annual_hiv_false_pos$Date == 2025],
...
monthly_hiv_false_pos_plot <- plot_ly(
  data = monthly_hiv_false_pos,
  x = ~Date,
  y = ~hiv_false_pos,
  type = 'scatter',
  mode = 'lines',
  ...
  layout(
    yaxis = list(title = 'Total HIV False Positive Tests'))
