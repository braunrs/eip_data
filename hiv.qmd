...
annual_hiv_testing <- select(enc, enc_date, record_id, ctr_calc, ehe_calc)
...
enc$hiv_inability_to_contact[enc$hiv_ltc == 1 &
                               enc$ltc_hiv_prevented_rsn___19 == 1] <- 1
table(enc$hiv_inability_to_contact)

table(enc$hiv_inability_to_contact)
hiv_inability_to_contact <- enc[which(enc$hiv_inability_to_contact == 1), ]
...
enc$hiv_ineligible_ltc[enc$hiv_already_linked == 1 |
                         ...
                         enc$hiv_inability_to_contact == 1 |
...
eip_2023$hiv_linkage_declined_2023[(eip_2023$hiv_ltc_2023 == 1 &
                                     ...
                                     (is.na(eip_2023$hiv_already_linked_2023) &
                                        ...
                                        is.na(eip_2023$hiv_incarcerated_2023))] <- 1
...
eip_2024$hiv_linkage_declined_2024[(eip_2024$hiv_ltc_2024 == 1 &
                                     ...
                                     (is.na(eip_2024$hiv_already_linked_2024) &
                                        ...
                                        is.na(eip_2024$hiv_incarcerated_2024))] <- 1
...
eip_2025$hiv_linkage_declined_2025[(eip_2025$hiv_ltc_2025 == 1 &
                                     ...
                                     (is.na(eip_2025$hiv_already_linked_2025) &
                                        ...
                                        is.na(eip_2025$hiv_incarcerated_2025))] <- 1
...
Daily HIV testing can also be tracked for each independent program and is shown in the chart below.
...
config(daily_hiv_testing_plot, displayModeBar = FALSE)
