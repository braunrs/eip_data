...
datatable(monthly_hiv_testing_table,
          options = list(
            pageLength = 10,
            lengthMenu = c(10, 25, 50, 100)),
          class = "display",
          colnames = colnames(monthly_hiv_testing_table)) %>%
  formatStyle(
    columns = names(monthly_hiv_testing_table),
    fontSize = '12px')
...
datatable(daily_hiv_testing_table,
          options = list(
            pageLength = 10,
            lengthMenu = c(10, 25, 50, 100)),
          class = "display",
          colnames = colnames(daily_hiv_testing_table)) %>%
  formatStyle(
    columns = names(daily_hiv_testing_table),
    fontSize = '12px')
