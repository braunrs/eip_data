...
### EIP Database Data
# 2023
eip23 <- read.csv('M:/EIP Data/EIP Database/REDCap 2023/EIP Database Data 20240813_1043.csv')
dim(eip23)
...
# 2024
eip24 <- read.csv('M:/EIP Data/EIP Database/REDCap 2024/EIP Database Data 20240814_1336.csv')
dim(eip24)
